...
export default function ProfileCard({
  ...
  const layoutTransition = isMobile ? { duration: 0 } : fluidTransition;
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            animate={{
              scale: expanded ? 1.6 : 0.8,
              opacity: expanded ? 1 : 0,
              rotate: expanded ? [0, 360] : 0, // Slow rotation
            }}
          ...
          <AnimatePresence mode="wait">
            {expanded && (
              <motion.div
                ...
                variants={isMobile ? undefined : contentContainerVariants}
              ...
              >
                ...
                <div className="flex items-center justify-between gap-6 mb-1">
                  <motion.h3
                    variants={isMobile ? undefined : elegantItemVariants}
