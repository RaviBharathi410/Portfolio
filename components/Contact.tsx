    ...
    <section id="contact" ref={sectionRef} className="relative py-32 overflow-hidden px-6">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-4 reveal-contact">
          <a href="mailto:ravibharathiv410@gmail.com" className="primary-btn px-8 py-4 rounded-2xl flex items-center gap-3">
            <Mail size={20} />
          ...
          <div className="flex gap-4 w-full justify-center md:w-auto">
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="glass w-14 h-14 rounded-2xl flex items-center justify-center hover:bg-white/5 transition-all">
              <Linkedin size={22} />
            </a>
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="glass w-14 h-14 rounded-2xl flex items-center justify-center hover:bg-white/5 transition-all">
              <Github size={22} />
            </a>
          </div>
        </div>
